...
export const sendForgetPasswordOtp = async (toEmail, name, otp) => {
    try {
...
export const sendVerificationEmail = async (email, fullName, otp) => {
    try {
        const html = wrapEmailTemplate('Verify Your Email', `
...
export const sendVerificationEmailLink = async (email, fullName, verificationUrl) => {
    try {
        const html = wrapEmailTemplate('Activate Your Account', `
        <p>Hello <strong>${fullName}</strong>,</p>
...
export const sendSignupNotificationToAdmin = async (fullName, email) => {
    try {
        const html = wrapEmailTemplate('New User Signup – Action Required', `
        <p>Hello Admin,</p>
