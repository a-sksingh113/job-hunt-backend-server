...
export const getAllSeeker = async (_req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ success: false, message: error.message || "Error fetching seekers" });
  }
};

export const getAllEmployer = async (_req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ success: false, message: error.message || "Error fetching employers" });
  }
};
...
export const approveJobSeekerById = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ success: true, message: "JobSeeker approved", user });
  } catch (error: any) {
...
export const rejectJobSeekerById = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ success: true, message: "JobSeeker rejected and removed" });
  } catch (error: any) {
...
export const rejectEmployerById = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ success: true, message: "Employer rejected and removed" });
  } catch (error: any) {
