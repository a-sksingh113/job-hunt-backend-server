...
export const postJob = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: `Job post error: ${error.message}` });
  }
};
...
export const updateJob = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: `Update job error: ${error.message}` });
  }
};
...
export const deleteJob = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: `Delete job error: ${error.message}` });
  }
};
